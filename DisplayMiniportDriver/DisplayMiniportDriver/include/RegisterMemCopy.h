...
inline BOOLEAN RegisterMemCopyVV32(volatile void* const Destination, const volatile void* const Source, const UINT64 ByteCount)
{
...
inline BOOLEAN RegisterMemCopyNV32(void* const Destination, const volatile void* const Source, const UINT64 ByteCount)
{
    const UINT_PTR destinationAddress = (UINT_PTR) Destination;
    const UINT_PTR sourceAddress = (UINT_PTR) Source;
